# Generated by Django 2.0.4 on 2018-10-13 15:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20, verbose_name='姓名')),
                ('price', models.CharField(max_length=4, verbose_name='价格')),
                ...
                ('phone', models.CharField(max_length=11, verbose_name='手机号')),
                ('is_enroll', models.CharField(max_length=10, verbose_name='是否学员')),
                ('is_return', models.CharField(max_length=40, verbose_name='是否往返')),
                ('is_need', models.BooleanField(verbose_name='是否需要提供其余服务')),
