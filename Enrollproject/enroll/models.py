...
class Student(models.Model):
	...
	class Meta:
		 verbose_name_plural='2020报名信息表'
	def __str__(self):	 	
		return self.name
class Student2(models.Model):
	name = models.CharField(max_length = 20,verbose_name='姓名',blank=False)
	price = models.CharField(max_length = 4,verbose_name='价格',blank=False)
	...
	is_enroll = models.CharField(max_length=10,blank=False,verbose_name = '是否学员')

	is_return = models.CharField(max_length=40,blank=False,verbose_name = '是否往返')
	is_need = models.BooleanField(blank=True,verbose_name = '是否需要提供其余服务')
	...
	class Meta:
		 verbose_name_plural='2019直通车信息表'
	def __str__(self):	 	
		return self.name
