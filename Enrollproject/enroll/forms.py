...
class StudentForm(forms.Form):
	...
	qq = forms.CharField(max_length = 12,min_length=6,strip=True)
	obj_school = forms.CharField(max_length = 100,strip=True)
	institute = forms.CharField(max_length = 100,strip=True,required=True)
	major = forms.CharField(max_length = 100,strip=True)
